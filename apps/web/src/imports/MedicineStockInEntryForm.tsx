import svgPaths from "./svg-8dgk8e53im";
import imgProfile from "figma:asset/b7d2f87d0e5e9b71cc10f785ea6e8e29a48bd48b.png";
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[16px]" data-name="Container">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 20">
        <g id="Container">
          <path d={svgPaths.p3b22eb80} fill="var(--fill-0, #2A9D90)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Container2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Inter:Black',sans-serif] font-black h-[28px] justify-center leading-[0] not-italic relative shrink-0 text-[#2a9d90] text-[18px] tracking-[-0.45px] w-[101.27px]">
...
function HorizontalBorder() {
  return (
    <div className="h-[64px] relative shrink-0 w-full" data-name="HorizontalBorder">
      <div aria-hidden="true" className="absolute border-[#dde4e3] border-b border-solid inset-0 pointer-events-none" />
  ...
  return (
    <div className="h-[13.333px] relative shrink-0 w-[15.833px]" data-name="Container">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.8333 13.3333">
        <g id="Container">
          <path d={svgPaths.p8b68280} fill="var(--fill-0, #678380)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Container6() {
  return (
    <div className="relative shrink-0 size-[16.667px]" data-name="Container">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.6667 16.6667">
        <g id="Container">
          <path d={svgPaths.p368b7f00} fill="var(--fill-0, #2A9D90)" id="Icon" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="bg-[rgba(42,157,144,0.1)] relative rounded-[8px] shrink-0 w-full" data-name="Link">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center px-[12px] py-[8px] relative w-full">
          <Container6 />
          <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#2a9d90] text-[14px] w-[63.22px]">
...
function Aside() {
  return (
    <div className="bg-white content-stretch flex flex-col h-full items-start pr-px relative shrink-0 w-[256px] z-[2]" data-name="Aside">
      <div aria-hidden="true" className="absolute border-[#dde4e3] border-r border-solid inset-0 pointer-events-none" />
      <HorizontalBorder />
      <Nav />
    </div>
  );
...
function Heading() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Heading 1">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[28px] justify-center leading-[0] not-italic relative shrink-0 text-[#121716] text-[20px] w-[93.63px]">
  ...
  return (
    <div className="h-[13.333px] relative shrink-0 w-[12px]" data-name="Container">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 13.3333">
        <g id="Container">
          <path d={svgPaths.p270cf300} fill="var(--fill-0, #678380)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Background1() {
  return (
    <div className="bg-[#f1f5f9] content-stretch flex gap-[8px] items-center px-[12px] py-[6px] relative rounded-[9999px] shrink-0" data-name="Background">
      <Container11 />
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium h-[16px] justify-center leading-[0] not-italic relative shrink-0 text-[#678380] text-[12px] w-[163.66px]">
...
function Container14() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-[rgba(103,131,128,0.7)] w-full">
...
function Input() {
  return (
    <div className="bg-[#f8fafc] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start pb-[12px] pl-[40px] pr-[16px] pt-[11px] relative w-full">
          <Container14 />
        </div>
      </div>
      <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_0px_0px_0px_white,inset_0px_0px_0px_1px_#dde4e3]" />
    </div>
  );
}
...
function Container19() {
  return (
    <div className="content-stretch flex flex-col items-end relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold h-[14px] justify-center leading-[0] not-italic relative shrink-0 text-[#121716] text-[14px] text-right w-[109.73px]">
...
function Container20() {
  return (
    <div className="content-stretch flex flex-col items-end relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[12px] justify-center leading-[0] not-italic relative shrink-0 text-[#678380] text-[12px] text-right w-[49.06px]">
        <p className="leading-[12px] whitespace-pre-wrap">CSASHS</p>
      </div>
    </div>
  );
}
...
function Profile() {
  return (
    <div className="flex-[1_0_0] h-full min-h-px min-w-px relative" data-name="Profile">
...
function Background3() {
  return (
    <div className="bg-white content-stretch flex flex-[1_0_0] items-center justify-center min-h-px min-w-px overflow-clip relative rounded-[9999px] w-full" data-name="Background">
      <Profile />
    </div>
  );
}
...
function Background2() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center p-[2px] relative rounded-[9999px] shrink-0 size-[36px]" data-name="Background" style={{ backgroundImage: "linear-gradient(45deg, rgb(42, 157, 144) 0%, rgb(52, 211, 153) 100%)" }}>
      <Background3 />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Container">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Container">
          <path d={svgPaths.p643d217} fill="var(--fill-0, #2A9D90)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Overlay() {
  return (
    <div className="bg-[rgba(42,157,144,0.1)] content-stretch flex items-center justify-center relative rounded-[8px] shrink-0 size-[40px]" data-name="Overlay">
      <Container23 />
    </div>
  );
}
...
function Container24() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#2a9d90] text-[14px] tracking-[0.7px] uppercase w-[124.66px]">
        <p className="leading-[20px] whitespace-pre-wrap">ADA Inventory</p>
      </div>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full" data-name="Heading 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative w-full">
        <div className="flex flex-col font-['Inter:Black',sans-serif] font-black justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[30px] tracking-[-0.75px] w-full">
          <p className="leading-[36px] whitespace-pre-wrap">Stock-in Medicine</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative w-full">
        <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#678380] text-[16px] w-full">
          <p className="leading-[24px] whitespace-pre-wrap">Record incoming inventory shipments quickly.</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Label">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[14px] w-full">
        <p className="whitespace-pre-wrap">
          <span className="leading-[24px]">{`Medicine Name `}</span>
          <span className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic text-[#ef4444]">*</span>
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="h-[18px] relative shrink-0 w-[14px]" data-name="Container">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 18">
        <g id="Container">
          <path d={svgPaths.p3be98a0} fill="var(--fill-0, #678380)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function ImageFill() {
  return (
    <div className="absolute content-stretch flex flex-col h-[56px] items-start justify-center left-0 overflow-clip pl-[502px] pr-[8px] py-[16px] top-0 w-[534px]" data-name="image fill">
      <Svg />
    </div>
  );
}
...
function Container31() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col items-start left-[40px] overflow-clip right-[40px] top-1/2" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[24px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[16px] w-[152.47px]">
        <p className="leading-[24px] whitespace-pre-wrap">Paracetamol 500mg</p>
      </div>
    </div>
  );
}
...
function Options() {
  return (
    <div className="bg-[#f8fafc] h-[56px] relative rounded-[8px] shrink-0 w-full" data-name="Options">
      <ImageFill />
      <div className="absolute bg-[rgba(255,255,255,0)] inset-0 rounded-[8px]" data-name="Options:shadow">
        <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_0px_0px_0px_white,inset_0px_0px_0px_1px_#dde4e3]" />
      </div>
      <Container31 />
    </div>
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#678380] text-[12px] w-full">
        <p className="leading-[16px] whitespace-pre-wrap">Search available medicines in the catalog</p>
      </div>
    </div>
  );
}
...
function Label1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Label">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[14px] w-full">
        <p className="whitespace-pre-wrap">
          <span className="leading-[24px]">{`Quantity Received `}</span>
          <span className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic text-[#ef4444]">*</span>
        </p>
      </div>
    </div>
...
function Container41() {
  return (
    <div className="absolute bottom-0 content-stretch flex items-center pr-[12px] right-0 top-0" data-name="Container">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium h-[24px] justify-center leading-[0] not-italic relative shrink-0 text-[#678380] text-[16px] w-[39.42px]">
        <p className="leading-[24px] whitespace-pre-wrap">Units</p>
      </div>
    </div>
  );
}
...
function Label2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Label">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[14px] w-full">
        <p className="whitespace-pre-wrap">
          <span className="leading-[24px]">{`Date Received `}</span>
          <span className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic text-[#ef4444]">*</span>
        </p>
      </div>
    </div>
...
function Paragraph() {
  return (
    <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-px items-start leading-[0] not-italic px-px relative self-stretch shrink-0 text-[#0f172a] text-[16px]" data-name="Paragraph">
      ...
      <div className="flex flex-col h-[24px] justify-center relative shrink-0 w-[18.81px]">
        <p className="leading-[24px] whitespace-pre-wrap">27</p>
      </div>
      <div className="flex flex-col h-[24px] justify-center relative shrink-0 w-[5.77px]">
        <p className="leading-[24px] whitespace-pre-wrap">/</p>
      </div>
...
function Input2() {
  return (
    <div className="bg-[#f8fafc] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start pl-[40px] pr-[16px] py-[16px] relative w-full">
          <Container44 />
        </div>
      </div>
      <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_0px_0px_0px_white,inset_0px_0px_0px_1px_#dde4e3]" />
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[18px]" data-name="Container">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 20">
        <g id="Container">
          <path d={svgPaths.p2a946800} fill="var(--fill-0, #678380)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Container35() {
  return (
    <div className="content-stretch flex gap-[24px] h-[92px] items-start justify-center relative shrink-0 w-full" data-name="Container">
      <Container36 />
      <Container42 />
    </div>
  );
...
function Heading2() {
  return (
    <div className="relative shrink-0 w-full" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative w-full">
        <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#678380] text-[14px] w-full">
          <p className="leading-[20px] whitespace-pre-wrap">Optional Details</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#6b7280] text-[14px] w-full">
        <p className="leading-[normal] whitespace-pre-wrap">e.g. Pharma Global Inc.</p>
      </div>
    </div>
  );
}
...
function Input3() {
  return (
    <div className="bg-white relative rounded-[8px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] shrink-0 w-full" data-name="Input">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start pb-[18px] pl-[40px] pr-[16px] pt-[17px] relative w-full">
          <Container51 />
        </div>
      </div>
      <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_0px_0px_0px_white,inset_0px_0px_0px_1px_#dde4e3]" />
  ...
  return (
    <div className="h-[16px] relative shrink-0 w-[22px]" data-name="Container">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 16">
        <g id="Container">
          <path d={svgPaths.p146eb80} fill="var(--fill-0, #678380)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Label4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Label">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[14px] w-full">
        <p className="leading-[24px] whitespace-pre-wrap">Expiry Date</p>
      </div>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-px items-start leading-[0] not-italic pl-px pr-[1.01px] relative self-stretch shrink-0 text-[#678380] text-[14px]" data-name="Paragraph">
      <div className="flex flex-col h-[24px] justify-center relative shrink-0 w-[24.53px]">
        <p className="leading-[24px] whitespace-pre-wrap">mm</p>
      </div>
      <div className="flex flex-col h-[24px] justify-center relative shrink-0 w-[5.05px]">
        <p className="leading-[24px] whitespace-pre-wrap">/</p>
      </div>
      <div className="flex flex-col h-[24px] justify-center relative shrink-0 w-[17.16px]">
        <p className="leading-[24px] whitespace-pre-wrap">dd</p>
      </div>
      <div className="flex flex-col h-[24px] justify-center relative shrink-0 w-[5.05px]">
        <p className="leading-[24px] whitespace-pre-wrap">/</p>
      </div>
      <div className="flex flex-col h-[24px] justify-center relative shrink-0 w-[31.48px]">
        <p className="leading-[24px] whitespace-pre-wrap">yyyy</p>
      </div>
    </div>
  );
}
...
function Container59() {
  return (
    <div className="h-[20px] relative shrink-0 w-[18px]" data-name="Container">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 20">
        <g id="Container">
          <path d={svgPaths.p12f74c00} fill="var(--fill-0, #678380)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function HorizontalBorder1() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start pt-[17px] relative shrink-0 w-full" data-name="HorizontalBorder">
      <div aria-hidden="true" className="absolute border-[#dde4e3] border-solid border-t inset-0 pointer-events-none" />
      <Heading2 />
      <Container48 />
    </div>
  );
  ...
  return (
    <div className="relative rounded-[8px] shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center px-[24px] py-[12px] relative">
        <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#475569] text-[14px] text-center w-[47.03px]">
...
function Button1() {
  return (
    <div className="bg-[#2a9d90] relative rounded-[8px] shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center justify-center px-[32px] py-[12px] relative">
        <div className="absolute bg-[rgba(255,255,255,0)] inset-[0_-0.67px_0_0] rounded-[8px] shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1),0px_2px_4px_-2px_rgba(0,0,0,0.1)]" data-name="Button:shadow" />
        <Container60 />
        <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-center text-white w-[94.22px]">
          <p className="leading-[20px] whitespace-pre-wrap">Save Stock-in</p>
        </div>
      </div>
    </div>
  );
...
function BackgroundHorizontalBorder1() {
  return (
    <div className="bg-[#f8fafc] relative shrink-0 w-full" data-name="Background+HorizontalBorder">
      <div aria-hidden="true" className="absolute border-[#dde4e3] border-solid border-t inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-between pb-[24px] pt-[25px] px-[32px] relative w-full">
          <Button />
          <Button1 />
        </div>
      </div>
...
function BackgroundBorderShadow() {
  return (
    <div className="bg-white relative rounded-[12px] shrink-0 w-full" data-name="Background+Border+Shadow">
      ...
      <div aria-hidden="true" className="absolute border border-[#dde4e3] border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]" />
    </div>
  );
}
...
function Container61() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[16px] justify-center leading-[0] not-italic relative shrink-0 text-[#678380] text-[12px] text-center w-[266.61px]">
        <p className="whitespace-pre-wrap">
          <span className="leading-[16px]">{`Changes are auto-saved to drafts. `}</span>
          <span className="[text-decoration-skip-ink:none] decoration-solid font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic underline">View history</span>
        </p>
      </div>
    </div>
  );
...
function Container21() {
  return (
    <div className="h-full max-w-[600px] relative shrink-0 w-[600px]" data-name="Container">
      <div className="content-stretch flex flex-col items-start max-w-[inherit] pb-[48px] relative size-full">
  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-full z-[1]" data-name="Main">
      <div className="flex flex-row justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-start justify-center pb-[32px] pt-[48px] px-[32px] relative size-full">
          <Container21 />
        </div>
      </div>
    </div>
...
export default function MedicineStockInEntryForm() {
  return (
    <div className="bg-[#f4f6f8] content-stretch flex isolate items-start relative size-full" data-name="Medicine Stock-In Entry Form">
      <Aside />
      <Background />
    </div>
  );
