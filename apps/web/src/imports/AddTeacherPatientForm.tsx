import svgPaths from "./svg-0va95q0a44";
import imgBackground from "figma:asset/5ea0eebd771bf63239ea9b58415cbe741903fdde.png";
...
function Background() {
  return (
    <div className="bg-[#2a9d90] content-stretch flex items-center justify-center relative rounded-[8px] shrink-0 size-[32px]" data-name="Background">
      <Container3 />
    </div>
  );
}
...
function Heading() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 1">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[16px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[12px] tracking-[0.6px] w-[75.36px]">
        <p className="leading-[16px] whitespace-pre-wrap">ADA CLINIC</p>
      </div>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium h-[15px] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[10px] tracking-[1px] uppercase w-[57.5px]">
...
function Container4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[75.36px]" data-name="Container">
      <Heading />
      <Container5 />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[18px]" data-name="Container">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="Container">
          <path d={svgPaths.p186f5ba0} fill="var(--fill-0, #64748B)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Container9() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#2a9d90] text-[14px] w-[55.86px]">
...
function Aside() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[452px] items-start justify-center pr-px relative shrink-0 w-[256px] z-[2]" data-name="Aside">
...
function Container21() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium h-[16px] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[12px] w-[163.66px]">
...
function Container20() {
  return (
    <div className="relative shrink-0 w-[163.66px]" data-name="Container">
    ...
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] w-full">
        <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#94a3b8] text-[14px] w-full">
          <p className="leading-[normal] whitespace-pre-wrap">Search for patients, records, or ID numbers...</p>
        </div>
      </div>
    </div>
  );
...
function Container23() {
  return (
    <div className="content-stretch flex flex-col items-start max-w-[512px] relative self-stretch shrink-0 w-[512px]" data-name="Container">
      <Input />
      <Container25 />
    </div>
  );
...
function Container22() {
  return (
    <div className="content-stretch flex h-[42px] items-start justify-center max-w-[576px] relative shrink-0 w-full" data-name="Container">
      <Container23 />
    </div>
  );
}
...
function Background1() {
  return (
    <div className="relative rounded-[9999px] shrink-0 size-[32px]" data-name="Background">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <div className="-translate-y-1/2 absolute bg-[rgba(255,255,255,0)] left-0 rounded-[9999px] shadow-[0px_0px_0px_2px_white,0px_1px_2px_0px_rgba(0,0,0,0.05)] size-[32px] top-1/2" data-name="Overlay+Shadow" />
      </div>
    </div>
  );
}
...
function Container28() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold h-[18px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[14px] text-center w-[109.73px]">
...
function Container29() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium h-[15px] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[10px] text-center w-[41.16px]">
        <p className="leading-[15px] whitespace-pre-wrap">CSASHS</p>
      </div>
    </div>
  );
}
...
function Header() {
  return (
    <div className="backdrop-blur-[6px] bg-[rgba(255,255,255,0.8)] relative shrink-0 w-full z-[2]" data-name="Header">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pb-[13px] pl-[24px] pr-[24.02px] pt-[12px] relative w-full">
          <Container20 />
          <Margin1 />
          <Button />
        </div>
...
function Heading2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Heading 2">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[28px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[20px] w-[161.8px]">
        <p className="leading-[28px] whitespace-pre-wrap">Add New Patient</p>
      </div>
    </div>
  );
}
...
function Label() {
  return (
    <div className="relative self-stretch shrink-0" data-name="Label">
      <div className="content-stretch flex flex-col h-full items-start pb-[6.5px] pt-[5.5px] px-[16px] relative">
        <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[14px] w-[52.3px]">
...
function BackgroundShadow() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start px-[16px] py-[6px] relative rounded-[6px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] shrink-0" data-name="Background+Shadow">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[14px] w-[54.5px]">
...
function Label2() {
  return (
    <div className="relative self-stretch shrink-0" data-name="Label">
      <div className="content-stretch flex flex-col h-full items-start pb-[6.5px] pt-[5.5px] px-[16px] relative">
        <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[14px] w-[31.91px]">
...
function Background2() {
  return (
    <div className="bg-[#f1f5f9] content-stretch flex h-[40px] items-start p-[4px] relative rounded-[8px] shrink-0" data-name="Background">
      <Label />
      <Label1 />
      <Label2 />
    </div>
    ...
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative w-full">
        <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[14px] w-full">
          <p className="leading-[20px] whitespace-pre-wrap">Please fill in the information below to create a new teacher profile in the system.</p>
        </div>
      </div>
    </div>
  );
...
function HorizontalBorder() {
  return (
    <div className="relative shrink-0 w-full" data-name="HorizontalBorder">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[24px] items-start pb-[17px] pt-[24px] px-[24px] relative w-full">
        <Container33 />
        <Container34 />
      </div>
    </div>
...
function Container36() {
  return (
    <div className="relative shrink-0 size-[15px]" data-name="Container">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g id="Container">
          <path d={svgPaths.p962d500} fill="var(--fill-0, #2A9D90)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Heading3() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Heading 3">
      <Container36 />
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#2a9d90] text-[14px] tracking-[0.7px] uppercase w-[157.02px]">
        <p className="leading-[20px] whitespace-pre-wrap">Basic Information</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Label">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#334155] text-[14px] w-full">
        <p className="leading-[20px] whitespace-pre-wrap">Full Name</p>
      </div>
    </div>
  );
}
...
function Container39() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] w-full">
        <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#94a3b8] text-[14px] w-full">
          <p className="leading-[normal] whitespace-pre-wrap">e.g. Jonathan Doe</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-[#f8fafc] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start pb-[13px] pt-[12px] px-[11px] relative w-full">
          <Container39 />
        </div>
      </div>
...
function Container38() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[6px] items-start left-0 right-[371px] top-0" data-name="Container">
      <Label3 />
      <Input1 />
    </div>
  );
...
function Label4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Label">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#334155] text-[14px] w-full">
        <p className="leading-[20px] whitespace-pre-wrap">Employee ID</p>
      </div>
    </div>
  );
}
...
function Container41() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] w-full">
        <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#94a3b8] text-[14px] w-full">
          <p className="leading-[normal] whitespace-pre-wrap">e.g. T-2023-445</p>
        </div>
      </div>
    </div>
  );
...
function Container40() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[6px] items-start left-[371px] right-0 top-0" data-name="Container">
      <Label4 />
      <Input2 />
    </div>
  );
...
function ImageFill() {
  return (
    <div className="absolute content-stretch flex flex-col h-[42px] items-start justify-center left-0 overflow-clip pl-[317px] pr-[9px] py-[10.5px] top-0 w-[347px]" data-name="image fill">
      <Svg />
    </div>
  );
}
...
function Container43() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col items-start left-[11px] overflow-clip right-[11px] top-1/2" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[14px] w-[92.25px]">
...
function Container42() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[6px] items-start left-0 right-[371px] top-[92px]" data-name="Container">
      <Label5 />
      <Options />
    </div>
  );
...
function Container44() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[6px] items-start left-[371px] right-0 top-[92px]" data-name="Container">
      <Label6 />
      <Input3 />
    </div>
  );
...
function SeparatorMargin() {
  return (
    <div className="h-px relative shrink-0 w-full" data-name="Separator:margin">
  ...
  return (
    <div className="h-[13.5px] relative shrink-0 w-[16.5px]" data-name="Container">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.5 13.5">
        <g id="Container">
          <path d={svgPaths.p1fa90a80} fill="var(--fill-0, #2A9D90)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Heading4() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Heading 3">
      <Container47 />
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#2a9d90] text-[14px] tracking-[0.7px] uppercase w-[186.83px]">
        <p className="leading-[20px] whitespace-pre-wrap">Academic Assignment</p>
      </div>
    </div>
  );
}
...
function Label7() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Label">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#334155] text-[14px] w-full">
        <p className="leading-[20px] whitespace-pre-wrap">Department/Unit</p>
      </div>
    </div>
  );
}
...
function Container50() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col items-start left-[11px] overflow-clip right-[11px] top-1/2" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[14px] w-[121.88px]">
        <p className="leading-[20px] whitespace-pre-wrap">Select department</p>
      </div>
    </div>
  );
}
...
function Label8() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Label">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#334155] text-[14px] w-full">
        <p className="leading-[20px] whitespace-pre-wrap">Position/Role</p>
      </div>
    </div>
  );
}
...
function Container52() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] w-full">
        <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#94a3b8] text-[14px] w-full">
          <p className="leading-[normal] whitespace-pre-wrap">e.g. Senior Lecturer</p>
        </div>
      </div>
    </div>
  );
...
function Container48() {
  return (
    <div className="content-stretch flex gap-[24px] h-[68px] items-start justify-center relative shrink-0 w-full" data-name="Container">
      <Container49 />
      <Container51 />
    </div>
  );
...
function Overlay() {
  return (
    <div className="bg-[rgba(42,157,144,0.05)] relative shrink-0 w-full" data-name="Overlay">
      <div className="content-stretch flex flex-col gap-[16px] items-start p-[24px] relative w-full">
        <Heading4 />
        <Container48 />
      </div>
  ...
  return (
    <div className="relative shrink-0 size-[13.5px]" data-name="Container">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.5 13.5">
        <g id="Container">
          <path d={svgPaths.pb3c9680} fill="var(--fill-0, #2A9D90)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Heading5() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Heading 3">
      <Container54 />
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#2a9d90] text-[14px] tracking-[0.7px] uppercase w-[187.44px]">
        <p className="leading-[20px] whitespace-pre-wrap">{`Contact & Emergency`}</p>
      </div>
    </div>
  );
}
...
function Container57() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] w-full">
        <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#94a3b8] text-[14px] w-full">
          <p className="leading-[normal] whitespace-pre-wrap">(555) 000-0000</p>
        </div>
      </div>
    </div>
  );
...
function Container59() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] w-full">
        <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#94a3b8] text-[14px] w-full">
          <p className="leading-[normal] whitespace-pre-wrap">email@school.edu</p>
        </div>
      </div>
    </div>
  );
...
function Container64() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] w-full">
        <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#94a3b8] text-[14px] w-full">
          <p className="leading-[normal] whitespace-pre-wrap">Relation</p>
        </div>
      </div>
    </div>
  );
...
function Label13() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Label">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#334155] text-[14px] w-full">
        <p className="leading-[20px] whitespace-pre-wrap">Emergency Phone</p>
      </div>
    </div>
  );
}
...
function Container60() {
  return (
    <div className="content-stretch flex gap-[24px] h-[76px] items-start justify-center pt-[8px] relative shrink-0 w-full" data-name="Container">
      <Container61 />
      <Container63 />
      <Container65 />
    </div>
...
function Container68() {
  return (
    <div className="relative shrink-0 size-[15px]" data-name="Container">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g id="Container">
          <path d={svgPaths.pb9e8300} fill="var(--fill-0, #2A9D90)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Heading6() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Heading 3">
      <Container68 />
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#2a9d90] text-[14px] tracking-[0.7px] uppercase w-[123.86px]">
        <p className="leading-[20px] whitespace-pre-wrap">Medical Notes</p>
      </div>
    </div>
  );
}
...
function Label14() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Label">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#334155] text-[14px] w-full">
        <p className="leading-[20px] whitespace-pre-wrap">Existing Conditions / Allergies</p>
      </div>
    </div>
  );
}
...
function Container70() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative w-full">
        <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#94a3b8] text-[14px] w-full">
          <p className="leading-[20px] whitespace-pre-wrap">Enter any important medical information...</p>
        </div>
      </div>
    </div>
  );
...
function Textarea() {
  return (
    <div className="bg-[#f8fafc] relative rounded-[8px] shrink-0 w-full" data-name="Textarea">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start pb-[51px] pt-[11px] px-[11px] relative w-full">
          <Container70 />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
  ...
  return (
    <div className="bg-[#2a9d90] relative rounded-[8px] shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center px-[20px] py-[10px] relative">
        <div className="absolute bg-[rgba(255,255,255,0)] inset-[0_0.5px_0_0] rounded-[8px] shadow-[0px_4px_6px_-1px_rgba(42,157,144,0.2),0px_2px_4px_-2px_rgba(42,157,144,0.2)]" data-name="Button:shadow" />
        <Container71 />
        <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-center text-white w-[84.98px]">
  ...
  return (
    <div className="bg-[#f8fafc] relative shrink-0 w-full" data-name="Background+HorizontalBorder">
      ...
      <div className="flex flex-row items-center justify-end size-full">
        <div className="content-stretch flex gap-[12.01px] items-center justify-end pb-[24px] pt-[25px] px-[24px] relative w-full">
          <Button1 />
          <Button2 />
        </div>
      </div>
...
function Container32() {
  return (
    <div className="content-stretch flex flex-col items-start max-w-[768px] relative self-stretch shrink-0 w-[768px]" data-name="Container">
...
function Container31() {
  return (
    <div className="h-[1149px] relative shrink-0 w-full z-[1]" data-name="Container">
...
function Main() {
  return (
    <div className="bg-[#f6f8f8] content-stretch flex flex-[1_0_0] flex-col h-[1600px] isolate items-start min-h-px min-w-px overflow-clip relative z-[1]" data-name="Main">
      <Header />
      <Container31 />
    </div>
  );
...
function Container() {
  return (
    <div className="content-stretch flex isolate items-start min-h-[1600px] overflow-clip relative shrink-0 w-full" data-name="Container">
      <Aside />
      <Main />
    </div>
  );
...
export default function AddTeacherPatientForm() {
  return (
    <div className="bg-[#f6f8f8] content-stretch flex flex-col items-start relative size-full" data-name="Add Teacher Patient Form">
      <Container />
    </div>
  );
}